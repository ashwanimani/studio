...
function SiteSettingsPlaceholderPageContent() {
  return (
      ...
      <Card className="w-full max-w-lg text-center shadow-lg">
        ...
        <CardContent>
          ...
          <p className="text-muted-foreground mb-6">
            Configuration options for the site will be available here soon. Please check back later!
          </p>
          <Button asChild>
...
export default function SiteSettingsPage() {
  return (
    <AdminAuthGuard>
      <SiteSettingsPlaceholderPageContent />
    </AdminAuthGuard>
  );
}
